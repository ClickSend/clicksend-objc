#import "SWGAccountForgotPasswordVerify.h"

@implementation SWGAccountForgotPasswordVerify
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"subaccountId": @"subaccount_id", @"activationToken": @"activation_token", @"password": @"password" }];
}
