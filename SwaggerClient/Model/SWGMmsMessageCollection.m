#import "SWGMmsMessageCollection.h"

@implementation SWGMmsMessageCollection
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"mediaFile": @"media_file", @"messages": @"messages" }];
}
