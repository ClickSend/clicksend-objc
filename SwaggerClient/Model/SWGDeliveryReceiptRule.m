...
@implementation SWGDeliveryReceiptRule
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"ruleName": @"rule_name", @"matchType": @"match_type", @"action": @"action", @"actionAddress": @"action_address", @"enabled": @"enabled" }];
}
