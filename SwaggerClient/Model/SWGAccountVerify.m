#import "SWGAccountVerify.h"

@implementation SWGAccountVerify
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"country": @"country", @"userPhone": @"user_phone", @"type": @"type" }];
}
