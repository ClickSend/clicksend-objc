#import "SWGEmailDeliveryReceiptRulesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGDeliveryReceiptRule.h"


@interface SWGEmailDeliveryReceiptRulesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGEmailDeliveryReceiptRulesApi

NSString* kSWGEmailDeliveryReceiptRulesApiErrorDomain = @"SWGEmailDeliveryReceiptRulesApiErrorDomain";
NSInteger kSWGEmailDeliveryReceiptRulesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) emailDeliveryReceiptAutomationDeleteWithReceiptRuleId: (NSNumber*) receiptRuleId
    ...
    if (receiptRuleId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGEmailDeliveryReceiptRulesApiErrorDomain code:kSWGEmailDeliveryReceiptRulesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/automations/email/receipts/{receipt_rule_id}"];
...
-(NSURLSessionTask*) emailDeliveryReceiptAutomationPostWithDeliveryReceiptRule: (SWGDeliveryReceiptRule*) deliveryReceiptRule
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/automations/email/receipts"];
