...
#import "SWGFaxMessageCollection.h"
...
@implementation SWGFaxApi

NSString* kSWGFaxApiErrorDomain = @"SWGFaxApiErrorDomain";
NSInteger kSWGFaxApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) faxHistoryGetWithDateFrom: (NSNumber*) dateFrom
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/fax/history"];
...
-(NSURLSessionTask*) faxPricePostWithFaxMessage: (SWGFaxMessageCollection*) faxMessage
    ...
    if (faxMessage == nil) {
        NSParameterAssert(faxMessage);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"faxMessage"] };
            NSError* error = [NSError errorWithDomain:kSWGFaxApiErrorDomain code:kSWGFaxApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/fax/price"];
...
-(NSURLSessionTask*) faxReceiptsByMessageIdGetWithMessageId: (NSString*) messageId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/fax/receipts/{message_id}"];
...
-(NSURLSessionTask*) faxSendPostWithFaxMessage: (SWGFaxMessageCollection*) faxMessage
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/fax/send"];
