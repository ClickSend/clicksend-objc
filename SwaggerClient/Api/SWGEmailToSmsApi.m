#import "SWGEmailToSmsApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGEmailSMSAddress.h"


@interface SWGEmailToSmsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGEmailToSmsApi

NSString* kSWGEmailToSmsApiErrorDomain = @"SWGEmailToSmsApiErrorDomain";
NSInteger kSWGEmailToSmsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) smsEmailSmsGetWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/email-sms"];
...
-(NSURLSessionTask*) smsEmailSmsPostWithEmailSmsAddress: (SWGEmailSMSAddress*) emailSmsAddress
    ...
    if (emailSmsAddress == nil) {
        NSParameterAssert(emailSmsAddress);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"emailSmsAddress"] };
            NSError* error = [NSError errorWithDomain:kSWGEmailToSmsApiErrorDomain code:kSWGEmailToSmsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
...
-(NSURLSessionTask*) smsEmailSmsStrippedStringDeleteWithRuleId: (NSNumber*) ruleId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/email-sms-stripped-strings/{rule_id}"];
...
-(NSURLSessionTask*) smsEmailSmsStrippedStringPostWithStrippedString: (NSString*) strippedString
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/email-sms-stripped-strings"];
