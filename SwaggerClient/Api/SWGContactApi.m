#import "SWGContactApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGContact.h"


@interface SWGContactApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGContactApi

NSString* kSWGContactApiErrorDomain = @"SWGContactApiErrorDomain";
NSInteger kSWGContactApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) listsContactsByListIdAndContactIdDeleteWithListId: (NSNumber*) listId
    ...
    if (listId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGContactApiErrorDomain code:kSWGContactApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
