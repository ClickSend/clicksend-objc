...
@interface SWGTransferCreditApi: NSObject <SWGApi>

extern NSString* kSWGTransferCreditApiErrorDomain;
extern NSInteger kSWGTransferCreditApiMissingParamErrorCode;
