#import "SWGContactListApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGContactListImport.h"


@interface SWGContactListApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGContactListApi

NSString* kSWGContactListApiErrorDomain = @"SWGContactListApiErrorDomain";
NSInteger kSWGContactListApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) listsByListIdDeleteWithListId: (NSNumber*) listId
    ...
    if (listId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGContactListApiErrorDomain code:kSWGContactListApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
