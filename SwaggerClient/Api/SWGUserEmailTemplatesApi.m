#import "SWGUserEmailTemplatesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGEmailTemplateNew.h"
#import "SWGEmailTemplateUpdate.h"


@interface SWGUserEmailTemplatesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGUserEmailTemplatesApi

NSString* kSWGUserEmailTemplatesApiErrorDomain = @"SWGUserEmailTemplatesApiErrorDomain";
NSInteger kSWGUserEmailTemplatesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) emailTemplateDeleteWithTemplateId: (NSNumber*) templateId
    ...
    if (templateId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGUserEmailTemplatesApiErrorDomain code:kSWGUserEmailTemplatesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
