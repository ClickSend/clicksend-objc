#import "SWGAccountRechargeApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGCreditCard.h"


@interface SWGAccountRechargeApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGAccountRechargeApi

NSString* kSWGAccountRechargeApiErrorDomain = @"SWGAccountRechargeApiErrorDomain";
NSInteger kSWGAccountRechargeApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) rechargeCreditCardPutWithCreditCard: (SWGCreditCard*) creditCard
    ...
    if (creditCard == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGAccountRechargeApiErrorDomain code:kSWGAccountRechargeApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
