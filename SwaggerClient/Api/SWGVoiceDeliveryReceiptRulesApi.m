#import "SWGVoiceDeliveryReceiptRulesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGDeliveryReceiptRule.h"


@interface SWGVoiceDeliveryReceiptRulesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGVoiceDeliveryReceiptRulesApi

NSString* kSWGVoiceDeliveryReceiptRulesApiErrorDomain = @"SWGVoiceDeliveryReceiptRulesApiErrorDomain";
NSInteger kSWGVoiceDeliveryReceiptRulesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) voiceDeliveryReceiptAutomationDeleteWithReceiptRuleId: (NSNumber*) receiptRuleId
    ...
    if (receiptRuleId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGVoiceDeliveryReceiptRulesApiErrorDomain code:kSWGVoiceDeliveryReceiptRulesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/automations/voice/receipts/{receipt_rule_id}"];
...
-(NSURLSessionTask*) voiceDeliveryReceiptAutomationPostWithDeliveryReceiptRule: (SWGDeliveryReceiptRule*) deliveryReceiptRule
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/automations/voice/receipts"];
