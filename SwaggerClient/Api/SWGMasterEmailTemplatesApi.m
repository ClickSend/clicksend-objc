#import "SWGMasterEmailTemplatesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGMasterEmailTemplatesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGMasterEmailTemplatesApi

NSString* kSWGMasterEmailTemplatesApiErrorDomain = @"SWGMasterEmailTemplatesApiErrorDomain";
NSInteger kSWGMasterEmailTemplatesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) masterEmailTemplateCategoryGetWithCategoryId: (NSNumber*) categoryId
    ...
    if (categoryId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGMasterEmailTemplatesApiErrorDomain code:kSWGMasterEmailTemplatesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
