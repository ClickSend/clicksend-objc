#import "SWGMmsCampaignApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGMmsCampaign.h"


@interface SWGMmsCampaignApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGMmsCampaignApi

NSString* kSWGMmsCampaignApiErrorDomain = @"SWGMmsCampaignApiErrorDomain";
NSInteger kSWGMmsCampaignApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) mmsCampaignByMmsCampaignIdGetWithMmsCampaignId: (NSNumber*) mmsCampaignId
    ...
    if (mmsCampaignId == nil) {
        NSParameterAssert(mmsCampaignId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"mmsCampaignId"] };
            NSError* error = [NSError errorWithDomain:kSWGMmsCampaignApiErrorDomain code:kSWGMmsCampaignApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    if (mmsCampaignId != nil) {
        pathParams[@"mms_campaign_id"] = mmsCampaignId;
    }
...
-(NSURLSessionTask*) mmsCampaignsCancelByMmsCampaignIdPutWithMmsCampaignId: (NSNumber*) mmsCampaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/mms-campaigns/{mms_campaign_id}/cancel"];
...
-(NSURLSessionTask*) mmsCampaignsGetWithPage: (NSNumber*) page
    ...
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/mms-campaigns"];
...
-(NSURLSessionTask*) mmsCampaignsPricePostWithCampaign: (SWGMmsCampaign*) campaign
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/mms-campaigns/price"];
...
-(NSURLSessionTask*) mmsCampaignsSendPostWithCampaign: (SWGMmsCampaign*) campaign
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/mms-campaigns/send"];
