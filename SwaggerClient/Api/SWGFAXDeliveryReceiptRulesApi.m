#import "SWGFAXDeliveryReceiptRulesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGDeliveryReceiptRule.h"


@interface SWGFAXDeliveryReceiptRulesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGFAXDeliveryReceiptRulesApi

NSString* kSWGFAXDeliveryReceiptRulesApiErrorDomain = @"SWGFAXDeliveryReceiptRulesApiErrorDomain";
NSInteger kSWGFAXDeliveryReceiptRulesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) faxDeliveryReceiptAutomationDeleteWithReceiptRuleId: (NSNumber*) receiptRuleId
    ...
    if (receiptRuleId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGFAXDeliveryReceiptRulesApiErrorDomain code:kSWGFAXDeliveryReceiptRulesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
