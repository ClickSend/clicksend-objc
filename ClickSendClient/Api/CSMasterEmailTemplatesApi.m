...
@interface CSMasterEmailTemplatesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSMasterEmailTemplatesApi

NSString* kCSMasterEmailTemplatesApiErrorDomain = @"CSMasterEmailTemplatesApiErrorDomain";
NSInteger kCSMasterEmailTemplatesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) masterEmailTemplateCategoriesGetWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/email/master-templates-categories"];
...
-(NSURLSessionTask*) masterEmailTemplateCategoryGetWithCategoryId: (NSNumber*) categoryId
    ...
    if (categoryId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSMasterEmailTemplatesApiErrorDomain code:kCSMasterEmailTemplatesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/email/master-templates-categories/{category_id}"];
...
-(NSURLSessionTask*) masterEmailTemplateGetWithTemplateId: (NSNumber*) templateId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/email/master-templates/{template_id}"];
...
-(NSURLSessionTask*) masterEmailTemplatesGetWithPage: (NSNumber*) page
    limit: (NSNumber*) limit
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/email/master-templates"];
...
-(NSURLSessionTask*) masterEmailTemplatesInCategoryGetWithCategoryId: (NSNumber*) categoryId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/email/master-templates-categories/{category_id}/master-templates"];
