#import "SWGNumberApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGNumberApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGNumberApi

NSString* kSWGNumberApiErrorDomain = @"SWGNumberApiErrorDomain";
NSInteger kSWGNumberApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) numbersBuyByDedicatedNumberPostWithDedicatedNumber: (NSString*) dedicatedNumber
    ...
    if (dedicatedNumber == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGNumberApiErrorDomain code:kSWGNumberApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
