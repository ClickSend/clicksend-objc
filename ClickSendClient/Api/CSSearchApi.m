...
@interface CSSearchApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSSearchApi

NSString* kCSSearchApiErrorDomain = @"CSSearchApiErrorDomain";
NSInteger kCSSearchApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) searchContactsListsGetWithQ: (NSString*) q
    ...
    if (q == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSSearchApiErrorDomain code:kCSSearchApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/search/contacts-lists"];
