...
@interface CSVoiceDeliveryReceiptRulesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSVoiceDeliveryReceiptRulesApi

NSString* kCSVoiceDeliveryReceiptRulesApiErrorDomain = @"CSVoiceDeliveryReceiptRulesApiErrorDomain";
NSInteger kCSVoiceDeliveryReceiptRulesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) voiceDeliveryReceiptAutomationDeleteWithReceiptRuleId: (NSNumber*) receiptRuleId
    ...
    if (receiptRuleId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSVoiceDeliveryReceiptRulesApiErrorDomain code:kCSVoiceDeliveryReceiptRulesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
