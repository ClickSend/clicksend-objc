...
@interface CSResellerAccountApi: NSObject <CSApi>

extern NSString* kCSResellerAccountApiErrorDomain;
extern NSInteger kCSResellerAccountApiMissingParamErrorCode;
