...
@interface CSVoiceApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSVoiceApi

NSString* kCSVoiceApiErrorDomain = @"CSVoiceApiErrorDomain";
NSInteger kCSVoiceApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) voiceReceiptsReadPutWithDateBefore: (CSDateBefore*) dateBefore
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/receipts-read"];
