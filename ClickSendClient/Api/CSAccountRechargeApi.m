...
@interface CSAccountRechargeApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSAccountRechargeApi

NSString* kCSAccountRechargeApiErrorDomain = @"CSAccountRechargeApiErrorDomain";
NSInteger kCSAccountRechargeApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) rechargeCreditCardGetWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/recharge/credit-card"];
...
-(NSURLSessionTask*) rechargeCreditCardPutWithCreditCard: (CSCreditCard*) creditCard
    ...
    if (creditCard == nil) {
        NSParameterAssert(creditCard);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"creditCard"] };
            NSError* error = [NSError errorWithDomain:kCSAccountRechargeApiErrorDomain code:kCSAccountRechargeApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
...
-(NSURLSessionTask*) rechargePackagesGetWithCountry: (NSString*) country
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/recharge/packages"];
...
-(NSURLSessionTask*) rechargePurchaseByPackageIdPutWithPackageId: (NSNumber*) packageId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/recharge/purchase/{package_id}"];
...
-(NSURLSessionTask*) rechargeTransactionsByTransactionIdGetWithTransactionId: (NSString*) transactionId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/recharge/transactions/{transaction_id}"];
...
-(NSURLSessionTask*) rechargeTransactionsGetWithPage: (NSNumber*) page
    ...
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/recharge/transactions"];
