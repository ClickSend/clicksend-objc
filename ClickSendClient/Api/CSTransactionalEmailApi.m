...
@interface CSTransactionalEmailApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSTransactionalEmailApi

NSString* kCSTransactionalEmailApiErrorDomain = @"CSTransactionalEmailApiErrorDomain";
NSInteger kCSTransactionalEmailApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) emailHistoryExportGetWithFilename: (NSString*) filename
    ...
    if (filename == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSTransactionalEmailApiErrorDomain code:kCSTransactionalEmailApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
