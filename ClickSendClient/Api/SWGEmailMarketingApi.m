#import "SWGEmailMarketingApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGEmailCampaign.h"


@interface SWGEmailMarketingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGEmailMarketingApi

NSString* kSWGEmailMarketingApiErrorDomain = @"SWGEmailMarketingApiErrorDomain";
NSInteger kSWGEmailMarketingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) allowedEmailAddressPostWithEmailAddress: (NSString*) emailAddress
    ...
    if (emailAddress == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGEmailMarketingApiErrorDomain code:kSWGEmailMarketingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
