#import "CSPostDirectMailApi.h"
#import "CSQueryParamCollection.h"
#import "CSApiClient.h"
#import "CSPostDirectMail.h"


@interface CSPostDirectMailApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSPostDirectMailApi

NSString* kCSPostDirectMailApiErrorDomain = @"CSPostDirectMailApiErrorDomain";
NSInteger kCSPostDirectMailApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) postDirectMailCampaignsPricePostWithPostDirectMail: (CSPostDirectMail*) postDirectMail
    ...
    if (postDirectMail == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSPostDirectMailApiErrorDomain code:kCSPostDirectMailApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
