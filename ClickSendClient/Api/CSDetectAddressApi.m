...
@implementation CSDetectAddressApi

NSString* kCSDetectAddressApiErrorDomain = @"CSDetectAddressApiErrorDomain";
NSInteger kCSDetectAddressApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) detectAddressPostWithContent: (NSString*) content
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/post/letters/detect-address"];
