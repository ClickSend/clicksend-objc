#import "SWGSmsCampaignApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGSmsCampaign.h"


@interface SWGSmsCampaignApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGSmsCampaignApi

NSString* kSWGSmsCampaignApiErrorDomain = @"SWGSmsCampaignApiErrorDomain";
NSInteger kSWGSmsCampaignApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) smsCampaignBySmsCampaignIdGetWithSmsCampaignId: (NSNumber*) smsCampaignId
    ...
    if (smsCampaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGSmsCampaignApiErrorDomain code:kSWGSmsCampaignApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
