...
@interface SWGTransactionalEmailApi: NSObject <SWGApi>

extern NSString* kSWGTransactionalEmailApiErrorDomain;
extern NSInteger kSWGTransactionalEmailApiMissingParamErrorCode;
