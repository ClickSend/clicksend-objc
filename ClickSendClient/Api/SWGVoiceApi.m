#import "SWGVoiceApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGVoiceMessageCollection.h"


@interface SWGVoiceApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGVoiceApi

NSString* kSWGVoiceApiErrorDomain = @"SWGVoiceApiErrorDomain";
NSInteger kSWGVoiceApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) voiceCancelAllPutWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/cancel-all"];
...
-(NSURLSessionTask*) voiceCancelByMessageIdPutWithMessageId: (NSString*) messageId
    ...
    if (messageId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGVoiceApiErrorDomain code:kSWGVoiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/{message_id}/cancel"];
...
-(NSURLSessionTask*) voiceHistoryExportGetWithFilename: (NSString*) filename
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/history/export"];
...
-(NSURLSessionTask*) voiceHistoryGetWithDateFrom: (NSNumber*) dateFrom
    ...
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/history"];
...
-(NSURLSessionTask*) voiceLangGetWithCompletionHandler: 
    (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/lang"];
...
-(NSURLSessionTask*) voicePricePostWithVoiceMessages: (SWGVoiceMessageCollection*) voiceMessages
    ...
    if (voiceMessages == nil) {
        NSParameterAssert(voiceMessages);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"voiceMessages"] };
            NSError* error = [NSError errorWithDomain:kSWGVoiceApiErrorDomain code:kSWGVoiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/price"];
...
-(NSURLSessionTask*) voiceSendPostWithVoiceMessages: (SWGVoiceMessageCollection*) voiceMessages
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/voice/send"];
