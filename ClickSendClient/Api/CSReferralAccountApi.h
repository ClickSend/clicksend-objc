...
@interface CSReferralAccountApi: NSObject <CSApi>

extern NSString* kCSReferralAccountApiErrorDomain;
extern NSInteger kCSReferralAccountApiMissingParamErrorCode;
