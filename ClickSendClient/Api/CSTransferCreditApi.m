#import "CSTransferCreditApi.h"
#import "CSQueryParamCollection.h"
#import "CSApiClient.h"
#import "CSResellerAccountTransferCredit.h"


@interface CSTransferCreditApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSTransferCreditApi

NSString* kCSTransferCreditApiErrorDomain = @"CSTransferCreditApiErrorDomain";
NSInteger kCSTransferCreditApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) resellerTransferCreditPutWithResellerAccountTransferCredit: (CSResellerAccountTransferCredit*) resellerAccountTransferCredit
    ...
    if (resellerAccountTransferCredit == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSTransferCreditApiErrorDomain code:kCSTransferCreditApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
