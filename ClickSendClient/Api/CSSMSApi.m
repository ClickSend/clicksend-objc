...
@implementation CSSMSApi

NSString* kCSSMSApiErrorDomain = @"CSSMSApiErrorDomain";
NSInteger kCSSMSApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) smsCancelAllPutWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/cancel-all"];
...
-(NSURLSessionTask*) smsCancelByMessageIdPutWithMessageId: (NSString*) messageId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/{message_id}/cancel"];
...
-(NSURLSessionTask*) smsHistoryExportGetWithFilename: (NSString*) filename
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/history/export"];
    ...
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    NSString *acceptHeader = [self.apiClient.sanitizer selectHeaderAccept:@[@"application/json", @"application/csv"]];
    if(acceptHeader.length > 0) {
        headerParams[@"Accept"] = acceptHeader;
    }
...
-(NSURLSessionTask*) smsHistoryGetWithDateFrom: (NSNumber*) dateFrom
    ...
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/history"];
...
-(NSURLSessionTask*) smsPricePostWithSmsMessages: (CSSmsMessageCollection*) smsMessages
    ...
    if (smsMessages == nil) {
        NSParameterAssert(smsMessages);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"smsMessages"] };
            NSError* error = [NSError errorWithDomain:kCSSMSApiErrorDomain code:kCSSMSApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/price"];
...
-(NSURLSessionTask*) smsReceiptsByMessageIdGetWithMessageId: (NSString*) messageId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/receipts/{message_id}"];
...
-(NSURLSessionTask*) smsTemplatesByTemplateIdDeleteWithTemplateId: (NSNumber*) templateId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/templates/{template_id}"];
...
-(NSURLSessionTask*) smsTemplatesByTemplateIdPutWithTemplateId: (NSNumber*) templateId
    ...
    if (smsTemplate == nil) {
        NSParameterAssert(smsTemplate);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"smsTemplate"] };
            NSError* error = [NSError errorWithDomain:kCSSMSApiErrorDomain code:kCSSMSApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
...
-(NSURLSessionTask*) smsTemplatesGetWithPage: (NSNumber*) page
    limit: (NSNumber*) limit
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/templates"];
