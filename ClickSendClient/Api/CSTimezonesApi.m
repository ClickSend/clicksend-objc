...
@interface CSTimezonesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSTimezonesApi

NSString* kCSTimezonesApiErrorDomain = @"CSTimezonesApiErrorDomain";
NSInteger kCSTimezonesApiMissingParamErrorCode = 234513;
