#import "SWGInboundSMSRulesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGInboundSMSRule.h"


@interface SWGInboundSMSRulesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGInboundSMSRulesApi

NSString* kSWGInboundSMSRulesApiErrorDomain = @"SWGInboundSMSRulesApiErrorDomain";
NSInteger kSWGInboundSMSRulesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) smsInboundAutomationDeleteWithInboundRuleId: (NSNumber*) inboundRuleId
    ...
    if (inboundRuleId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGInboundSMSRulesApiErrorDomain code:kSWGInboundSMSRulesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
