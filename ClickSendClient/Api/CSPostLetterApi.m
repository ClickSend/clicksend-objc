...
@interface CSPostLetterApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSPostLetterApi

NSString* kCSPostLetterApiErrorDomain = @"CSPostLetterApiErrorDomain";
NSInteger kCSPostLetterApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) postLettersExportGetWithFilename: (NSString*) filename
    ...
    if (filename == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSPostLetterApiErrorDomain code:kCSPostLetterApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
