#import "CSMmsCampaignApi.h"
#import "CSQueryParamCollection.h"
#import "CSApiClient.h"
#import "CSMmsCampaign.h"


@interface CSMmsCampaignApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSMmsCampaignApi

NSString* kCSMmsCampaignApiErrorDomain = @"CSMmsCampaignApiErrorDomain";
NSInteger kCSMmsCampaignApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) mmsCampaignByMmsCampaignIdGetWithMmsCampaignId: (NSNumber*) mmsCampaignId
    ...
    if (mmsCampaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSMmsCampaignApiErrorDomain code:kCSMmsCampaignApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
