...
@implementation CSContactListApi

NSString* kCSContactListApiErrorDomain = @"CSContactListApiErrorDomain";
NSInteger kCSContactListApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) listsByListIdDeleteWithListId: (NSNumber*) listId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/lists/{list_id}"];
...
-(NSURLSessionTask*) listsByListIdPutWithListId: (NSNumber*) listId
    ...
    if (listName == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"listName"] };
            NSError* error = [NSError errorWithDomain:kCSContactListApiErrorDomain code:kCSContactListApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
...
-(NSURLSessionTask*) listsImportByListIdPostWithListId: (NSNumber*) listId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/lists/{list_id}/import"];
...
-(NSURLSessionTask*) listsRemoveDuplicatesByListIdPutWithListId: (NSNumber*) listId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/lists/{list_id}/remove-duplicates"];
