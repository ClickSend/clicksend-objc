...
@interface CSSMSDeliveryReceiptRulesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSSMSDeliveryReceiptRulesApi

NSString* kCSSMSDeliveryReceiptRulesApiErrorDomain = @"CSSMSDeliveryReceiptRulesApiErrorDomain";
NSInteger kCSSMSDeliveryReceiptRulesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) smsDeliveryReceiptAutomationDeleteWithReceiptRuleId: (NSNumber*) receiptRuleId
    ...
    if (receiptRuleId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCSSMSDeliveryReceiptRulesApiErrorDomain code:kCSSMSDeliveryReceiptRulesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
