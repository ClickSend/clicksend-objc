...
@interface CSCountriesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CSCountriesApi

NSString* kCSCountriesApiErrorDomain = @"CSCountriesApiErrorDomain";
NSInteger kCSCountriesApiMissingParamErrorCode = 234513;
