...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"username": @"username", @"password": @"password", @"userPhone": @"user_phone", @"userEmail": @"user_email", @"userFirstName": @"user_first_name", @"userLastName": @"user_last_name", @"accountName": @"account_name", @"country": @"country" }];
}
