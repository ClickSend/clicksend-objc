...
@implementation CSResellerAccountTransferCredit
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"clientUserId": @"client_user_id", @"balance": @"balance", @"currency": @"currency" }];
}
