...
@implementation SWGEmailTemplateNew
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"templateName": @"template_name", @"templateIdMaster": @"template_id_master" }];
}
