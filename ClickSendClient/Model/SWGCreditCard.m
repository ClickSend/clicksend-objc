#import "SWGCreditCard.h"

@implementation SWGCreditCard
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"number": @"number", @"expiryMonth": @"expiry_month", @"expiryYear": @"expiry_year", @"cvc": @"cvc", @"name": @"name", @"bankName": @"bank_name" }];
}
