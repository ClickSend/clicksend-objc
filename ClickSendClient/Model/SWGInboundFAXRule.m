...
@implementation SWGInboundFAXRule
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"dedicatedNumber": @"dedicated_number", @"ruleName": @"rule_name", @"action": @"action", @"actionAddress": @"action_address", @"enabled": @"enabled" }];
}
