...
NSString *const CSDeserializationErrorDomainKey = @"CSDeserializationErrorDomainKey";

NSInteger const CSTypeMismatchErrorCode = 143553;

NSInteger const CSEmptyValueOccurredErrorCode = 143509;

NSInteger const CSUnknownResponseObjectErrorCode = 143528;


@interface CSResponseDeserializer ()
...
@implementation CSResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:CSDeserializationErrorDomainKey code:CSTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:CSDeserializationErrorDomainKey code:CSEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:CSDeserializationErrorDomainKey code:CSUnknownResponseObjectErrorCode userInfo:userInfo];
}
