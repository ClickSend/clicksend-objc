...
NSString * const kCSApplicationJSONType = @"application/json";

NSString * CSPercentEscapedStringFromString(NSString *string) {
    static NSString * const kCSCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kCSCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kCSCharactersGeneralDelimitersToEncode stringByAppendingString:kCSCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[CSQueryParamCollection class]]) {
        return object;
    }
    else if ([object isKindOfClass:[NSDate class]]) {
        return [CSSanitizer dateToString:object];
    }
    ...
    else if ([object isKindOfClass:[CSObject class]]) {
...
- (NSString *) parameterToString:(id)param {
    if ([param isKindOfClass:[NSString class]]) {
        ...
        return [CSSanitizer dateToString:param];
    }
...
+ (NSString *)dateToString:(id)date {
    NSTimeZone* timeZone = [CSDefaultConfiguration sharedConfig].serializationTimeZone;
